...
// this is a fix for this issue: https://github.com/openlayers/openlayers/issues/910
// getCentoid can fail when to many digits to the right of the decimal are used in the geometry  
OpenLayers.Geometry.LinearRing.prototype.getCentroid = function(){
    if (this.components && (this.components.length > 2)) {
        return new OpenLayers.Geometry.Point(this.getBounds().getCenterLonLat().lon, this.getBounds().getCenterLonLat().lat);
    } else {
        return null;
    }
};

OpenLayers.Strategy.Cluster.prototype.deactivate = function() {
...
OpenLayers.Strategy.Cluster.prototype.activate = function() {
